...
int main() {
    setbuf(stdout, NULL);
    printf("%s", "META"); putchar(0); printf("%s", "file_name"); putchar(0); printf("%s", "00004.c"); putchar('\n');
    printf("%s", "META"); putchar(0); printf("%s", "file_path"); putchar(0); printf("%s", "/srv/mosiacs/data/00004.c"); putchar('\n');
    ...
    printf("%s", "META"); putchar(0); printf("%s", "accessed"); putchar(0); printf("%s", "2026-02-07 20:43:15"); putchar('\n');
    printf("%s", "META"); putchar(0); printf("%s", "created"); putchar(0); printf("%s", "2026-02-07 20:42:49"); putchar('\n');
