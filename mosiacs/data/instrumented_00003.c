int __stack_depth = 0;
int main() {
    printf("META"); putchar(0); printf("file_name"); putchar(0); printf("00003.c"); putchar('\n');
    printf("META"); putchar(0); printf("file_path"); putchar(0); printf("/srv/mosiacs/data/00003.c"); putchar('\n');
    printf("META"); putchar(0); printf("file_size"); putchar(0); printf("184"); putchar('\n');
    printf("META"); putchar(0); printf("file_mode"); putchar(0); printf("-rwxrwxrwx"); putchar('\n');
    printf("META"); putchar(0); printf("modified"); putchar(0); printf("2026-02-07 03:12:23"); putchar('\n');
    printf("META"); putchar(0); printf("accessed"); putchar(0); printf("2026-02-07 18:56:39"); putchar('\n');
    printf("META"); putchar(0); printf("created"); putchar(0); printf("2026-02-07 18:42:43"); putchar('\n');
    ...
    while (x > 0 || x == 10) {
    printf("LOOP"); putchar(0); printf("while"); putchar(0); printf("x > 0 || x == 10"); putchar(0); printf("%d", (x > 0 || x == 10)); putchar(0); printf("4"); putchar(0); printf("%d", __stack_depth); putchar('\n');
